...
#if we have argparse module imported, we can comand line args.
...
#if we do not have argparse module, one have to provide configure connection options manually.
